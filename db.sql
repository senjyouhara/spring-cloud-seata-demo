...
create database if not exists storage_db CHARACTER set utf8;
...
create database if not exists order_db CHARACTER set utf8;
...
create database if not exists account_db CHARACTER set utf8;
