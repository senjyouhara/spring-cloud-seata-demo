...
public class IndexController {
	...
	public IndexController(RestTemplate restTemplate, BusinessApplication.OrderService orderService,
	...
	public String feign() {
		...
		result = storageService.storage(COMMODITY_CODE, ORDER_COUNT);
		...
		log.info("Business Service End ... Created ");
